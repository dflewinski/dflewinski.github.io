...
function infoDescriptionOnCreate() {
    return '<div id="accordion">\n' +
        ...
        '<p>Dane zebrane przez użytkowników grupy <a href="">Świecka szkoła</a> przy użyciu wniosków do lokalnych samorządów o udzielenie informacji publicznej.</p>' +
        '<div>Źródła:</div>' +
...
L.tileLayer('', {
    attribution: '<a href="">Dane - Świecka szkoła - wielkopolskie</a>. <a href="https://www.paypal.com/paypalme/dflewinski">Wizualizacja - DFL</a> ',
}).addTo(map);
